...
MIDDLEWARE = [
    ...
    'core.middleware.LastPageMiddleware',
]

ROOT_URLCONF = 'secretmanager.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.pending_requests',
            ],
        },
    },
]

WSGI_APPLICATION = 'secretmanager.wsgi.application'
